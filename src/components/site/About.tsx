...
const pillars = [
  ...
  { icon: Compass, title: "Anadolu'daki Girişimler", body: "Tüm Anadolu'daki girişimcilere açıktır — risk sermayesinin yeterince ulaşamadığı şehirlerdeki yetenekleri ortaya çıkarır." },
  { icon: Network, title: "İstanbul Köprüsü", body: "Girişimcilerin yer değiştirmesine gerek kalmadan, İstanbul'un yatırımcı, mentor ve kurumsal ağına doğrudan erişim sağlar." },
  { icon: Building2, title: "Kamu-Özel Destekli", body: "Kurumsal ortaklar, bölgesel kalkınma ajansları ve özenle seçilmiş melek yatırımcı (bireysel yatırımcı) ağıyla birlikte inşa edildi." },
];
